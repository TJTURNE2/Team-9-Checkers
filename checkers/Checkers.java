...
//    ImageIcon redN=new ImageIcon(new ImageIcon(getClass().getResource("/images/red.png")).getImage());//red_normal.jpg	//OLD
    ImageIcon redN=new ImageIcon(new ImageIcon("images/red_normal.jpg").getImage());//red_normal.jpg								//FIXED
//    ImageIcon yellowN=new ImageIcon(new ImageIcon(getClass().getResource("/images/blue.png")).getImage());//yellow_normal.jpg	//OLD
    ImageIcon yellowN=new ImageIcon(new ImageIcon("images/yellow_normal.jpg").getImage());//yellow_normal.jpg//FIXED
//    ImageIcon redK=new ImageIcon(new ImageIcon(getClass().getResource("/images/rs.jpg")).getImage());//red_king.jpg		//OLD
    ImageIcon redK=new ImageIcon(new ImageIcon("images/red_king.jpg").getImage());//red_king.jpg			//FIXED
//    ImageIcon yellowK=new ImageIcon(new ImageIcon(getClass().getResource("/images/bs.jpg")).getImage());//yellow_king.jpg	//OLD
    ImageIcon yellowK=new ImageIcon(new ImageIcon("images/yellow_king.jpg").getImage());//yellow_king.jpg	//FIXED
//    ImageIcon hlp=new ImageIcon(new ImageIcon(getClass().getResource("/images/help.jpg")).getImage());//help.jpg			//OLD
    ImageIcon hlp=new ImageIcon(new ImageIcon("images/help.jpg").getImage());//help.jpg			//FIXED
//    ImageIcon snp=new ImageIcon(new ImageIcon(getClass().getResource("/images/sound.jpg")).getImage());//sound.jpg		//OLD
    ImageIcon snp=new ImageIcon(new ImageIcon("images/sound.jpg").getImage());//sound.jpg			//FIXED
//    ImageIcon mup=new ImageIcon(new ImageIcon(getClass().getResource("/images/mute.jpg")).getImage());//mute.jpg			//OLD
...
//            new PlaySound("src//sounds//option.wav").start();			//OLD
            new PlaySound("sounds//option.wav").start();			//FIXED
            col.setEnabled(true);
            col.setVisible(true);
...
//                    new PlaySound("src//sounds//comPlay.wav").start();			//OLD
                    new PlaySound("sounds//comPlay.wav").start();				//FIXED
                    play();
                }
...
//                new PlaySound("src//sounds//clickChecker.wav").start();		//OLD
                new PlaySound("sounds//clickChecker.wav").start();			//FIXED
            }
		}
